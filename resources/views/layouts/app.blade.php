            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    @if (Auth::user()->level == 1)
                        ...
                        @if (Request::path() === 'jabatan' || Request::path() === 'kegiatan-jabatan' )
                            @php($master = 'active')
                        @else
                            @php($master = '')
                        @endif
                                ...
                                <li class="{{ Request::path() === 'kegiatan-jabatan' ? 'active' : '' }}">
                                    <a href="{{ route('kegiatan-jabatan.index') }}">
                                        <table border="0">
                                            <tr>
                                                <td style="vertical-align: top"> <i class="fa fa-circle-o"></i></td>
                                                <td style="padding-left: 12px">Kegiatan Jabatan</td>
                                            </tr>
                                        </table>
                                    </a>
                                </li>
                    ...
                    @else
                        {{-- kondisi menu aktif master --}}
                        @if (Request::path() === 'jenis' || Request::path() === 'bentuk' || Request::path() === 'jalur' || Request::path() === 'nama' || Request::path() === 'penyelenggara' || Request::path() === 'standar' || Request::path() === 'usulan' || Request::path() === 'saran')
                            @php($master = 'active')
                        @else
                            @php($master = '')
                        @endif
                        ...
                        {{-- kondisi menu aktif hcdp --}}
                        @if (Request::path() === 'gap-assesment' || Request::path() === 'gap-assesment-potensi' || Request::path() === 'gap-kinerja')
                            @php($hcdp = 'active')
                        @else
                            @php($hcdp = '')
                        @endif

                        {{-- kondisi menu aktif assesment --}}
                        @if (Request::path() === 'gap-assesment' || Request::path() === 'gap-assesment-potensi')
                            @php($assesment = 'active')
                        @else
                            @php($assesment = '')
                        @endif

                        {{-- kondisi menu aktif pelaporan --}}
                        @if (Request::path() === 'laporan-pelatihan')
                            @php($pelaporan = 'active')
                        @else
                            @php($pelaporan = '')
                        @endif

                        {{-- pelaporan --}}
                        <li class="treeview {{ $pelaporan }}">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li class="{{ Request::path() === 'laporan-pelatihan' ? 'active' : '' }}">
                                    <a href="{{ route('laporan-pelatihan.index') }}">
                                        <table border="0">
                                            <tr>
                                                <td style="vertical-align: top"> <i class="fa fa-circle-o"></i></td>
                                                <td style="padding-left: 12px">Pelaporan Pelatihan <br />yang Belum
                                                    diikuti</td>
                                            </tr>
                                        </table>
                                    </a>
                                ...
                                <li style="display:none">
                                    <a href="#">
                                        <table border="0">
                                            <tr>
                                                <td style="vertical-align: top"> <i class="fa fa-circle-o"></i></td>
                                                <td style="padding-left: 12px">Penetapan Rencana <br /> Pengembangan SDM
                                                </td>
                                            </tr>
                                        </table>
                                    </a>
                                ...
                                <li style="display:none">
                                    <a href="#">
                                        <table border="0">
                                            <tr>
                                                <td style="vertical-align: top"> <i class="fa fa-circle-o"></i></td>
                                                <td style="padding-left: 12px">Roadmap Pengembangan <br />SDM</td>
                                            </tr>
                                        </table>
                                    </a>
                                </li>
                                <li style="display:none"><a href="#"><i class="fa fa-circle-o"></i> Statistik</a></li>
                            </ul>
                        </li>
                    @endif
                </ul>
