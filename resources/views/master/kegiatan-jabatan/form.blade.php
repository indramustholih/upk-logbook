        ...
        <div class="modal-content">
            <form class="form-horizontal" method="POST" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    {{-- Biaya --}}
                    <div class="form-group">
                        <label for="biaya" class="col-md-3 control-label">Angka Kredit</label>
                        <div class="col-md-6">
                    ...
                    {{-- <div class="form-group">
                        <label for="angka_kredit" class="col-md-3 control-label">Angka Kredit</label>
                        <div class="col-md-6">
                            <textarea class="form-control" id="angka_kredit" name="angka_kredit" placeholder="Bentuk Saran Pengembangan" autofocus required></textarea>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div> --}}
