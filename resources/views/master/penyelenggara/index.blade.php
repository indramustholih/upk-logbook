...
@section('content')
    ...
    @include('master.penyelenggara.form')
@endsection
...
@section('script')
    <script type="text/javascript">
        ...
        function addForm() {
            ...
            $('.modal-title').text('Tambah Penyelenggara Pelatihan');
        }
        ...
        function editForm(id) {
            ...
            $('#modal-form form')[0].reset();
            $.ajax({
                url: "penyelenggara/" + id + "/edit",
                type: "GET",
                dataType: "JSON",
                success: function(data) {
                    $('#modal-form').modal('show');
                    $('.modal-title').text('Edit Penyelenggara Pelatihan');
                    $('#id').val(data.id);
                    $('#kode').val(data.kode);
                    $('#penyelenggara_pelatihan').val(data.penyelenggara_pelatihan);
